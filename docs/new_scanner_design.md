...
===================================
This is a reference intended to be used by TAPClean scanner designers. It gives guidelines and code examples to follow when writing NEW scanners. To integrate a new scanner in TAPClean check the document new_scanner_integration.md.
