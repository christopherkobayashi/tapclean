...
- TODO: Consolidate the core processing in "Turbotape 250", "Turbotape 526", and "Turrican loader" as they use essentially the same file structure (192-byte header file + data file).
