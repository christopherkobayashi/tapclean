...
enum {	GAP=1, PAUSE, CBM_HEAD, CBM_DATA, TT_HEAD, TT_DATA, FREE, USGOLD, ACES,
	WILD,WILD_STOP,NOVA, NOVA_SPC, OCEAN_F1, OCEAN_F2, OCEAN_F3, CHR_T1,
	CHR_T2, CHR_T3, RASTER, CYBER_F1, CYBER_F2, CYBER_F3, CYBER_F4_1,
	CYBER_F4_2, CYBER_F4_3, BLEEP, BLEEP_TRIG, BLEEP_SPC, HITLOAD,
	MICROLOAD, BURNER, RACKIT, SPAV1_HD, SPAV1, SPAV2_HD, SPAV2, VIRGIN,
	HITEC, ANIROG, VISI_T1, VISI_T2, VISI_T3, VISI_T4, SUPERTAPE_HEAD,
	SUPERTAPE_DATA, PAV, IK, FBIRD1, FBIRD2, TURR_HEAD, TURR_DATA,
	SEUCK_L2, SEUCK_HEAD, SEUCK_DATA, SEUCK_TRIG, SEUCK_GAME, JET, FLASH,
	TDI_F1, OCNEW1T1, OCNEW1T2, OCNEW2, ATLAN, SNAKE51, SNAKE50T1,
	SNAKE50T2, PAL_F1, PAL_F2, ENIGMA, AUDIOGENIC
};
...
enum {	LID_FREE=1, LID_BLEEP, LID_CHR, LID_BURN, LID_WILD, LID_USG, LID_MIC,
	LID_ACE, LID_T250, LID_RACK, LID_OCEAN, LID_RAST, LID_SPAV, LID_HIT,
	LID_ANI, LID_VIS1, LID_VIS2, LID_VIS3, LID_VIS4, LID_FIRE, LID_NOVA,
	LID_IK, LID_PAV, LID_CYBER, LID_VIRG, LID_HTEC, LID_FLASH, LID_SUPER,
	LID_OCNEW1T1, LID_OCNEW1T2, LID_ATLAN, LID_SNAKE, LID_OCNEW2,
	LID_AUDIOGENIC
};
