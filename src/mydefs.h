...
#define VERSION_STR "TAPClean v0.09 Console - (C) 2006 XXX"
#define BUILDER     "ldf"
...
enum {	GAP=1, PAUSE, CBM_HEAD, CBM_DATA, TT_HEAD, TT_DATA, FREE, ODELOAD,
	...
	SNAKE50T1, SNAKE50T2, PAL_F1, PAL_F2, ENIGMA, AUDIOGENIC, ALIENSY, ACCOLADE
};
...
enum {	LID_FREE=1, LID_ODE, LID_BLEEP, LID_CHR, LID_BURN, LID_WILD, LID_USG,
	...
	LID_OCNEW2, LID_AUDIOGENIC, LID_CULT, LID_ACCOLADE
};
