...
enum {
	...
	VIRGIN, HITEC, ANIROG, VISI_T1, VISI_T2, VISI_T3, VISI_T4, VISI_T5, VISI_T6,
	SUPERTAPE_HEAD, SUPERTAPE_DATA, PAV, IK, FBIRD_T1, FBIRD_T2, TURR_HEAD, 
	TURR_DATA, SEUCK_L2, SEUCK_HEAD, SEUCK_DATA, SEUCK_TRIG, SEUCK_GAME, 
	JET, FLASH, TDI_F1, OCNEW1_T1, OCNEW1_T2, OCNEW2, ATLAN, SNAKE51, 
	SNAKE50_T1, SNAKE50_T2, PAL_F1, PAL_F2, ENIGMA, AUDIOGENIC, ALIENSY, 
	ACCOLADE, ALTERWG, RAINBOWARTS_F1, RAINBOWARTS_F2, TRILOGIC, BURNERVAR, 
	OCNEW4, TDI_F2, BITURBO, T108DE0A5, ACTIONREPLAY_HDR, ACTIONREPLAY_TURBO, 
	ACTIONREPLAY_STURBO, ASHDAVE, FREE_SLOW_T1, FREE_SLOW_T2, GOFORGOLD, 
	FASTEVIL, FFTAPE, TESTAPE, TEQUILA, ALTERSW, CHUCKIEEGG, ALTERDK_T1, 
	ALTERDK_T2, ALTERDK_T3, ALTERDK_T4, POWERLOAD, GREMLIN_F1, GREMLIN_F2, 
	AMACTION, CREATURES, RAINBOW_ISLANDS, OCNEW3, EASYTAPE, TURBO220, 
	CSPARKS, DIGITAL_DESIGN, CRL,
...
enum {
	...
	LID_HIT, LID_ANI, LID_VIS_T1, LID_VIS_T2, LID_VIS_T3, LID_VIS_T4, LID_VIS_T5,
	LID_VIS_T6, LID_FIRE, LID_NOVA, LID_IK, LID_PAV, LID_CYBER, LID_VIRG, LID_HTEC,
	LID_FLASH, LID_SUPER, LID_OCNEW1_T1, LID_OCNEW1_T2, LID_ATLAN, LID_SNAKE,
	...
	LID_CHUCKIEEGG, LID_ALTERDK, LID_POWERLOAD, LID_GREMLIN, LID_EASYTAPE,
	LID_CSPARKS, LID_TRILOGIC, LID_CRL
};
