/*---------------------------------------------------------------------------
  snakeload50t1.c (Snakeload 5.0, Threshold 1)
         ...
         if(readttbit(i, ft[SNAKE50T1].lp, ft[SNAKE50T1].sp, ft[SNAKE50T1].tp)==ft[SNAKE50T1].sv)
         {
            ...
            if(hd[0]==0x65 && hd[1]==0x69 && hd[2]==0x6C && hd[3]==0x79 && hd[4]==0x4B)
            {
               ...
               if(e>s)
               {
                  ...
                  {
                     while(tap.tmem[eof+1]>ft[SNAKE50T1].sp-tol && tap.tmem[eof+1]<ft[SNAKE50T1].sp+tol && eof<tap.len-1)
                        eof++;
                  }
